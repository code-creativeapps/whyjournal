...
- 0–3 habits. If the dream involves recurring practice (reading, training, writing, studying, exercising, language, meditation, journaling), include AT LEAST ONE habit with cadence aligned to the user's stated hours/time-of-day. Habit titles MUST start with a concrete METHOD or SLOT — not a vibe verb. Bad: "Practice Italian basics", "Dedicate 2 sessions to Italian", "Daily fitness practice", "Read every day". Good: "Pimsleur Italian, 30 min, Sun + Wed mornings", "20-min run before work", "10 pages before bed", "Anki flashcards over coffee". Banned habit-title leading words: "Practice", "Train", "Study", "Work on", "Dedicate", "Spend", "Do", "Engage with". Pick a concrete method on the user's behalf if the user said "I don't know" — that's your job, not theirs.
